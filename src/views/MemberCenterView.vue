        ...
        <form @submit.prevent="submitForm">
            <div class="wrap_mem_center">
                <div class="member_info_list">
                    ...
                    <div class="member_info">
                        <label>Email</label>
                        <input type="text" id="email" @blur="validateEmail" v-model="this.memberInfo[0].email" />
                    </div>
                    <div class="member_info">
                        <label>手機電話</label>
                        <input type="text" id="phone" @blur="validatePhone" v-model="this.memberInfo[0].phone" />
                    </div>
                    <input type="submit" class="big-btn-primary" style="display: inline-block; margin: 20px auto;"
                        value="儲存" />
                </div>
            </div>
        </form>
